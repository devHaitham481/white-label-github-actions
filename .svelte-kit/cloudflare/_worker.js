...
var getEnvironment, environment, handle;
var init_hooks_server = __esm({
  ".svelte-kit/output/server/chunks/hooks.server.js"() {
    ...
    environment = async ({ event, resolve }) => {
...
// .svelte-kit/output/server/chunks/superdupersecret.js
var superdupersecret_exports = {};
__export(superdupersecret_exports, {
  default: () => Superdupersecret
});
var Superdupersecret;
var init_superdupersecret = __esm({
  ".svelte-kit/output/server/chunks/superdupersecret.js"() {
    init_index2();
    Superdupersecret = create_ssr_component(($$result, $$props, $$bindings, slots) => {
...
var Navbar, capitalizeFirstLetter, normalizeComponentName, loadComponentsByEnv, getCustomComponentsByEnv, css, Layout;
var init_layout_svelte = __esm({
  ...
  <a class="font-semibold text-primary-800 hover:underline" href="/route">Route</a></nav>`;
    ...
    loadComponentsByEnv = (env) => {
      switch (env) {
        case "cloudflare":
          return /* @__PURE__ */ Object.assign({
            "/src/lib/custom/cloudflare/test.svelte": () => Promise.resolve().then(() => (init_test(), test_exports)).then((m) => m["default"])
          });
        case "repguide":
          return /* @__PURE__ */ Object.assign({
            "/src/lib/custom/repguide/superdupersecret.svelte": () => Promise.resolve().then(() => (init_superdupersecret(), superdupersecret_exports)).then((m) => m["default"])
          });
        case "development":
          return {
    ...
    getCustomComponentsByEnv = async (env) => {
      ...
      return Object.keys(components2).reduce((acc, key2) => {
        if (!key2)
          return acc;
        return { ...acc, [normalizeComponentName(key2)]: components2[key2] };
      }, {});
    };
    css = {
...
var index, component, server_id, imports, stylesheets, fonts;
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    ...
    imports3 = ["_app/immutable/nodes/2.6836797e.js", "_app/immutable/chunks/index.e6505d68.js", "_app/immutable/chunks/store.ef93056d.js", "_app/immutable/chunks/index.a76d1baa.js"];
    stylesheets3 = [];
    fonts3 = [];
  }
});

// .svelte-kit/output/server/entries/pages/route/_page.ts.js
var page_ts_exports = {};
...
// .svelte-kit/output/server/entries/pages/route/_page.svelte.js
...
var index4, component4, universal_id, imports4, stylesheets4, fonts4;
var init__4 = __esm({
  ".svelte-kit/output/server/nodes/3.js"() {
    init_page_ts();
    index4 = 3;
    component4 = async () => (await Promise.resolve().then(() => (init_page_svelte2(), page_svelte_exports2))).default;
    universal_id = "src/routes/route/+page.ts";
    imports4 = ["_app/immutable/nodes/3.1804cf13.js", "_app/immutable/chunks/index.e6505d68.js", "_app/immutable/chunks/store.ef93056d.js", "_app/immutable/chunks/index.a76d1baa.js"];
    stylesheets4 = [];
    fonts4 = [];
  }
});
...
var public_env = {};
function set_public_env(environment2) {
  public_env = environment2;
}
...
${constructors[1] ? `${validate_component(constructors[0] || missing_component, "svelte:component").$$render(
      $$result,
      { data: data_0, this: components2[0] },
      {
        this: ($$value) => {
          components2[0] = $$value;
          $$settled = false;
      ...
      },
      {
        default: () => {
          return `${validate_component(constructors[1] || missing_component, "svelte:component").$$render(
            $$result,
            { data: data_1, form, this: components2[1] },
            {
              this: ($$value) => {
                components2[1] = $$value;
                $$settled = false;
      ...
      $$result,
      { data: data_0, form, this: components2[0] },
      {
        this: ($$value) => {
          components2[0] = $$value;
          $$settled = false;
...
var options = {
  ...
  templates: {
    app: ({ head, body, assets: assets2, nonce, env }) => '<!DOCTYPE html>\n<html lang="en">\n	<head>\n		<meta charset="utf-8" />\n		<link rel="icon" href="' + assets2 + '/%sveltekit.env%/favicon.ico" />\n		<meta name="viewport" content="width=device-width" />\n		' + head + '\n	</head>\n	<body data-sveltekit-preload-data="hover">\n		<div style="display: contents">' + body + "</div>\n	</body>\n</html>\n",
...
var worker = {
  async fetch(req, env, context) {
    ...
    return res.status >= 400 ? res : c(req, res, context);
  }
};
